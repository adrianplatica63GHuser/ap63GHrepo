/**
 * Per-type UI configuration for the Paperwork form.
 *
...
import type { PaperworkType } from "./validation";
...
// ---------------------------------------------------------------------------
// Generic / fallback config — used for all 13 "simple" types
// ---------------------------------------------------------------------------
...
const CONFIG: Partial<Record<PaperworkType, TypeConfig>> = {
...
export function getTypeConfig(type: PaperworkType): TypeConfig {
  return CONFIG[type] ?? GENERIC;
}
