...
export function AssociatePartyView({ paperworkId, paperworkName }: Props) {
  const t           = useTranslations("paperwork.associateParty");
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      router.push(`/paperwork/${encodeURIComponent(paperworkId)}`);
    } catch (err) {
