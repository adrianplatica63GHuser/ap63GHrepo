...
export const lookupPropertyType = pgTable("lookup_property_type", {
  id:        uuid("id").primaryKey().defaultRandom(),
  name:      text("name").notNull(),
  // Slice #19.02: stable slug for type-config.ts (nullable — backfilled for
  // the six seeded rows; auto-generated by the admin value-list query layer
  // for any type created via Reference Data → Property Types).
  key:       text("key").unique(),
