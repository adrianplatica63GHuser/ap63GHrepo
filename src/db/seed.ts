...
// migration_020_rename_to_document.sql, the second Romanian wordings from
// migration_021_keep_alternate_wordings.sql, and their present keys from
// migration_071_doctype_rekey.sql.
//
// Slice #29.07: the five AUTORIZATIE rows moved to the 'Autorizație' type — the
// same reassignment `migration_043_doctype_cleanup.sql` makes to real
// documents. The seed loop THROWS on a key it cannot resolve and that migration
// DELETES the row then keyed AUTORIZATIE (name 'Autorizare'), so `npm run seed`
// had not been able to run against a migrated database since #043 landed, and
// the message it failed with named migration_020 — which does not create the
// second wording either. Both were fixed then.
//
// ⚠️ **AUTORIZATIE AND CERTIFICAT_SARCINI ARE HERE AGAIN AND DO NOT MEAN WHAT
// THEY MEANT.** migration_071 retired the `_ALT` suffix: 'Autorizație' is keyed
// AUTORIZATIE now, and CERTIFICAT_SARCINI has moved from 'Certificat de Bunuri'
// (which is CERTIFICAT_BUNURI) to 'Certificat de Sarcini'. The five rows below
// that used to read CERTIFICAT_SARCINI are titled "Certificat Sarcini …" and so
// belong under the name they always described, which is the key they now carry.
// EXTRAS_CARTE_FUNCIARA_ALT is gone entirely, folded into
...
const DOCUMENTS: SeedDocumentRow[] = [
  // ── ACT_ADJUDECARE ──────────────────────────────────────────────────────
  { typeKey: "ACT_ADJUDECARE", title: "Adjudecare Teren Snagov",    nrDocument: "1234/2019", dateDocument: "2019-04-12",  notes: "Executare silită dosar 445/2018" },
  { typeKey: "ACT_ADJUDECARE", title: "Adjudecare Lot 3 Balotești", nrDocument: "887/2020",  dateDocument: "2020-09-03",     notes: "Vânzare la licitație publică" },
  { typeKey: "ACT_ADJUDECARE", title: "Adjudecare Casă Cornetu",    nrDocument: "2201/2021", dateDocument: "2021-02-17" },
  { typeKey: "ACT_ADJUDECARE", title: "Adjudecare Teren Cernica",   nrDocument: "556/2022",  dateDocument: "2022-06-29",     notes: "Imobil adjudecat în urma executării" },
  { typeKey: "ACT_ADJUDECARE", title: "Adjudecare Parcelă Gruiu",   nrDocument: "310/2023",  dateDocument: "2023-11-08" },
  // ── ACT_CADASTRU ────────────────────────────────────────────────────────
  { typeKey: "ACT_CADASTRU", title: "Cadastru Teren Voluntari",   nrDocument: "CAD-1002/2018", dateDocument: "2018-07-15", notes: "Prima intabulare" },
  { typeKey: "ACT_CADASTRU", title: "Cadastru Lot Nord Snagov",   nrDocument: "CAD-2314/2019", dateDocument: "2019-03-22" },
  { typeKey: "ACT_CADASTRU", title: "Cadastru Parcelă Brănești",  nrDocument: "CAD-0887/2020", dateDocument: "2020-10-05", notes: "Actualizare după dezmembrare" },
  { typeKey: "ACT_CADASTRU", title: "Cadastru Teren Afumați",     nrDocument: "CAD-3001/2021", dateDocument: "2021-05-18" },
  { typeKey: "ACT_CADASTRU", title: "Cadastru Lot Tunari",        nrDocument: "CAD-1455/2022", dateDocument: "2022-08-30", notes: "Intabulare după retrocedare" },
  // ── ACT_DONATIE ─────────────────────────────────────────────────────────
  { typeKey: "ACT_DONATIE", title: "Donație Teren Voluntari", nrDocument: "101/2017", dateDocument: "2017-06-10" },
  { typeKey: "ACT_DONATIE", title: "Donație Casă Snagov",     nrDocument: "215/2019", dateDocument: "2019-01-25",       notes: "Imobil cu construcție" },
  ...
  { typeKey: "AVIZ_INSTITUTIE", title: "Aviz Apele Române — Construcție Mal", nrDocument: "AV-778/2021", dateDocument: "2021-04-22",   notes: "Construcție la 50 m de lac" },
  { typeKey: "AVIZ_INSTITUTIE", title: "Aviz Drumuri Naționale — Acces",      nrDocument: "AV-342/2022", dateDocument: "2022-07-18",       notes: "Acces rutier de pe DN1" },
  { typeKey: "AVIZ_INSTITUTIE", title: "Aviz Mediu — Extindere Fermă",        nrDocument: "AV-156/2023", dateDocument: "2023-01-30",                   notes: "Extindere activitate agricolă" },
  // ── CERTIFICAT_FISCAL ───────────────────────────────────────────────────
  { typeKey: "CERTIFICAT_FISCAL", title: "Certificat Fiscal Ion Popescu",         nrDocument: "CF-1001/2020", dateDocument: "2020-03-10" },
  { typeKey: "CERTIFICAT_FISCAL", title: "Certificat Fiscal SC Imobil SRL",       nrDocument: "CF-2234/2021", dateDocument: "2021-07-25", notes: "Lipsa datorii la data emiterii" },
  { typeKey: "CERTIFICAT_FISCAL", title: "Certificat Fiscal Gheorghe Constantin", nrDocument: "CF-0889/2021", dateDocument: "2021-11-04" },
  { typeKey: "CERTIFICAT_FISCAL", title: "Certificat Fiscal Elena Dinu",          nrDocument: "CF-3301/2022", dateDocument: "2022-05-19" },
  { typeKey: "CERTIFICAT_FISCAL", title: "Certificat Fiscal PFA Radu Sorin",      nrDocument: "CF-4412/2023", dateDocument: "2023-08-08", notes: "Valabil 30 zile de la emitere" },
  // ── CERTIFICAT_MOSTENITOR ───────────────────────────────────────────────
  { typeKey: "CERTIFICAT_MOSTENITOR", title: "Succesiune Popescu Vasile",   nrDocument: "55/2018",  dateDocument: "2018-09-12", nrDosarSuccesoral: "DOS-120/2018", dataDecesului: "2018-01-15", ultimulDomiciliu: "Str. Florilor 4, Voluntari",          nrCertificatDeces: "CD-334/2018" },
  { typeKey: "CERTIFICAT_MOSTENITOR", title: "Succesiune Ionescu Ana",     nrDocument: "88/2019",  dateDocument: "2019-04-30",   nrDosarSuccesoral: "DOS-067/2019", dataDecesului: "2018-11-22", ultimulDomiciliu: "Str. Trandafirilor 12, Snagov",       nrCertificatDeces: "CD-891/2018" },
  { typeKey: "CERTIFICAT_MOSTENITOR", title: "Succesiune Dumitrescu Gh.",  nrDocument: "112/2020", dateDocument: "2020-06-15",   nrDosarSuccesoral: "DOS-203/2020", dataDecesului: "2020-02-08", ultimulDomiciliu: "Bld. Unirii 5, Buftea",               nrCertificatDeces: "CD-102/2020",              notes: "Masa succesorală include teren 2.500 mp" },
  { typeKey: "CERTIFICAT_MOSTENITOR", title: "Succesiune Popa Florina",    nrDocument: "74/2021",  dateDocument: "2021-10-22", nrDosarSuccesoral: "DOS-311/2021", dataDecesului: "2021-03-17", ultimulDomiciliu: "Str. Luncii 8, Cernica",              nrCertificatDeces: "CD-445/2021" },
  { typeKey: "CERTIFICAT_MOSTENITOR", title: "Succesiune Radu Constantin", nrDocument: "201/2022", dateDocument: "2022-03-08",   nrDosarSuccesoral: "DOS-089/2022", dataDecesului: "2021-12-01", ultimulDomiciliu: "Str. Câmpului 23, Balotești",         nrCertificatDeces: "CD-778/2021" },
  { typeKey: "CERTIFICAT_MOSTENITOR", title: "Succesiune Stanescu Tudor",  nrDocument: "330/2023", dateDocument: "2023-07-14",   nrDosarSuccesoral: "DOS-415/2023", dataDecesului: "2023-01-09", ultimulDomiciliu: "Str. Primăverii 1, Afumați",          nrCertificatDeces: "CD-023/2023",              notes: "Unicul moștenitor legal" },
  // ── CERTIFICAT_SARCINI ──────────────────────────────────────────────────
  { typeKey: "CERTIFICAT_SARCINI", title: "Certificat Sarcini CF 12345", nrDocument: "CS-445/2019", dateDocument: "2019-06-20", notes: "Liber de sarcini la data emiterii" },
  { typeKey: "CERTIFICAT_SARCINI", title: "Certificat Sarcini CF 23890", nrDocument: "CS-778/2020", dateDocument: "2020-11-03", notes: "Ipotecă înscrisă în favoarea BCR" },
  { typeKey: "CERTIFICAT_SARCINI", title: "Certificat Sarcini CF 34012", nrDocument: "CS-102/2021", dateDocument: "2021-04-17" },
  { typeKey: "CERTIFICAT_SARCINI", title: "Certificat Sarcini CF 41233", nrDocument: "CS-556/2022", dateDocument: "2022-08-29", notes: "Liber de sarcini" },
  { typeKey: "CERTIFICAT_SARCINI", title: "Certificat Sarcini CF 50087", nrDocument: "CS-890/2023", dateDocument: "2023-02-14", notes: "Sechestru asigurator înscris" },
  // ── CERTIFICAT_URBANISM ─────────────────────────────────────────────────
  { typeKey: "CERTIFICAT_URBANISM", title: "CU Construire Locuință Voluntari",  nrDocument: "CU-112/2018", dateDocument: "2018-05-14",  notes: "Zonă rezidențială, POT 40%, CUT 1.2" },
  { typeKey: "CERTIFICAT_URBANISM", title: "CU Dezmembrare Lot Snagov",        nrDocument: "CU-034/2019", dateDocument: "2019-10-22",     notes: "Dezmembrare în 2 parcele" },
  { typeKey: "CERTIFICAT_URBANISM", title: "CU Extindere Imobil Gruiu",        nrDocument: "CU-209/2020", dateDocument: "2020-03-30" },
  { typeKey: "CERTIFICAT_URBANISM", title: "CU Amplasare Panouri Fotovoltaice",nrDocument: "CU-067/2021", dateDocument: "2021-07-08",    notes: "Instalare 48 panouri pe acoperiș" },
  { typeKey: "CERTIFICAT_URBANISM", title: "CU Schimbare Destinație Spațiu",   nrDocument: "CU-445/2022", dateDocument: "2022-12-19",     notes: "Din depozit în spațiu comercial" },
  // ── CONTRACT_ARENDA ─────────────────────────────────────────────────────
  { typeKey: "CONTRACT_ARENDA", title: "Arendă Teren Agricol Balotești", nrDocument: "CA-001/2019", dateDocument: "2019-03-01", dateStart: "2019-03-01", dateEnd: "2024-02-28",        notes: "12 ha teren arabil" },
  { typeKey: "CONTRACT_ARENDA", title: "Arendă Câmp Snagov",            nrDocument: "CA-045/2020", dateDocument: "2020-01-15",    dateStart: "2020-02-01", dateEnd: "2025-01-31",      notes: "8 ha pășune și arabil" },
  { typeKey: "CONTRACT_ARENDA", title: "Arendă Teren Gruiu",            nrDocument: "CA-112/2020", dateDocument: "2020-06-10",     dateStart: "2020-07-01", dateEnd: "2023-06-30",     notes: "5 ha arabil" },
  { typeKey: "CONTRACT_ARENDA", title: "Arendă Lot Agricol Cernica",    nrDocument: "CA-233/2021", dateDocument: "2021-04-05",   dateStart: "2021-04-15", dateEnd: "2026-04-14",     notes: "15 ha, inclusiv pășune" },
  { typeKey: "CONTRACT_ARENDA", title: "Arendă Teren Brănești",         nrDocument: "CA-089/2022", dateDocument: "2022-09-20",  dateStart: "2022-10-01", dateEnd: "2027-09-30",       notes: "20 ha teren arabil" },
  // ── CONTRACT_INCHIRIERE ─────────────────────────────────────────────────
  { typeKey: "CONTRACT_INCHIRIERE", title: "Închiriere Apartament Voluntari", nrDocument: "CI-301/2020", dateDocument: "2020-02-10", dateStart: "2020-03-01", dateEnd: "2021-02-28",           notes: "3 camere, et. 2, 75 mp" },
  { typeKey: "CONTRACT_INCHIRIERE", title: "Închiriere Spațiu Comercial",    nrDocument: "CI-445/2021", dateDocument: "2021-05-20",    dateStart: "2021-06-01", dateEnd: "2024-05-31",       notes: "120 mp parter" },
  { typeKey: "CONTRACT_INCHIRIERE", title: "Închiriere Casă Snagov",         nrDocument: "CI-112/2021", dateDocument: "2021-09-15",    dateStart: "2021-10-01", dateEnd: "2022-09-30",          notes: "Casă P+1, 150 mp" },
  { typeKey: "CONTRACT_INCHIRIERE", title: "Închiriere Depozit Afumați",     nrDocument: "CI-778/2022", dateDocument: "2022-03-01",   dateStart: "2022-04-01", dateEnd: "2025-03-31",    notes: "Depozit 500 mp" },
  { typeKey: "CONTRACT_INCHIRIERE", title: "Închiriere Birou Voluntari",     nrDocument: "CI-990/2023", dateDocument: "2023-07-12", dateStart: "2023-08-01", dateEnd: "2024-07-31",        notes: "Birou 45 mp, et. 1" },
  // ── CONTRACT_PARTAJ ─────────────────────────────────────────────────────
  { typeKey: "CONTRACT_PARTAJ", title: "Partaj Voluntar Succesiune Popescu", nrDocument: "211/2019", dateDocument: "2019-08-20",   notes: "Impartire lot 5.000 mp in 3 parti egale" },
  { typeKey: "CONTRACT_PARTAJ", title: "Partaj Bunuri Comune Ionescu",       nrDocument: "334/2020", dateDocument: "2020-04-14", notes: "Partaj in urma divortului" },
  { typeKey: "CONTRACT_PARTAJ", title: "Partaj Succesoral Constantin",       nrDocument: "102/2021", dateDocument: "2021-11-09",   notes: "2 moștenitori, câte 50%" },
  { typeKey: "CONTRACT_PARTAJ", title: "Partaj Teren Agricol Gruiu",         nrDocument: "567/2022", dateDocument: "2022-06-17",   notes: "Lot de 8 ha împărțit în 4 parcele" },
  { typeKey: "CONTRACT_PARTAJ", title: "Partaj Imobil Snagov",               nrDocument: "801/2023", dateDocument: "2023-09-03" },
  // ── CONTRACT_PRESTARI_SERVICII ──────────────────────────────────────────
  { typeKey: "CONTRACT_PRESTARI_SERVICII", title: "Contract Topografie Teren Voluntari", nrDocument: "CPS-010/2020", dateDocument: "2020-03-25",       notes: "Ridicare topografică 3 ha" },
  { typeKey: "CONTRACT_PRESTARI_SERVICII", title: "Contract Evaluare Imobil Snagov",    nrDocument: "CPS-078/2021", dateDocument: "2021-07-14",  notes: "Evaluare imobil 450 mp" },
  { typeKey: "CONTRACT_PRESTARI_SERVICII", title: "Contract Consultanță Juridică",      nrDocument: "CPS-145/2021", dateDocument: "2021-12-01",   notes: "Asistență juridică tranzacție imobiliară" },
  { typeKey: "CONTRACT_PRESTARI_SERVICII", title: "Contract Mediere Litigiu Funciar",   nrDocument: "CPS-223/2022", dateDocument: "2022-05-19", notes: "Mediere dispută de hotar" },
  { typeKey: "CONTRACT_PRESTARI_SERVICII", title: "Contract Proiect Arhitectură",       nrDocument: "CPS-399/2023", dateDocument: "2023-02-28",     notes: "Proiect construire P+1, 200 mp" },
  // ── CONTRACT_VANZARE ────────────────────────────────────────────────────
  { typeKey: "CONTRACT_VANZARE", title: "Vânzare Teren Voluntari 2.500 mp",  nrDocument: "1001/2018", dateDocument: "2018-06-14",          notes: "Teren intravilan, CF 12345" },
  { typeKey: "CONTRACT_VANZARE", title: "Vânzare Casă Snagov",               nrDocument: "1234/2019", dateDocument: "2019-11-20",          notes: "P+1, 180 mp utili" },
  { typeKey: "CONTRACT_VANZARE", title: "Vânzare Lot Agricol Balotești",     nrDocument: "0778/2020", dateDocument: "2020-04-08",             notes: "12 ha teren arabil, CF 23890" },
  { typeKey: "CONTRACT_VANZARE", title: "Vânzare Apartament Buftea",         nrDocument: "2201/2021", dateDocument: "2021-09-30",              notes: "2 camere, 54 mp, CF 34012" },
  { typeKey: "CONTRACT_VANZARE", title: "Vânzare Teren Intravilan Cernica",  nrDocument: "3301/2022", dateDocument: "2022-03-15",                notes: "Lot 1.200 mp" },
  { typeKey: "CONTRACT_VANZARE", title: "Vânzare Imobil Afumați",            nrDocument: "4455/2023", dateDocument: "2023-08-22", notes: "Casă + teren 850 mp, CF 50087" },
  // ── EXTRAS_CARTE_FUNCIARA ───────────────────────────────────────────────
  { typeKey: "EXTRAS_CARTE_FUNCIARA", title: "Extras CF 12345 — Informare",     nrDocument: "ECF-001/2019", dateDocument: "2019-04-10", notes: "Extras pentru informare, valabil 30 zile" },
  { typeKey: "EXTRAS_CARTE_FUNCIARA", title: "Extras CF 23890 — Autentificare", nrDocument: "ECF-112/2020", dateDocument: "2020-07-22", notes: "Extras pentru autentificarea contractului" },
  { typeKey: "EXTRAS_CARTE_FUNCIARA", title: "Extras CF 34012 — Informare",     nrDocument: "ECF-334/2021", dateDocument: "2021-02-18" },
  { typeKey: "EXTRAS_CARTE_FUNCIARA", title: "Extras CF 41233 — Autentificare", nrDocument: "ECF-556/2022", dateDocument: "2022-10-05", notes: "Extras pentru vânzare-cumpărare" },
  { typeKey: "EXTRAS_CARTE_FUNCIARA", title: "Extras CF 50087 — Informare",     nrDocument: "ECF-780/2023", dateDocument: "2023-05-30" },
  // ── EXTRAS_PUG ──────────────────────────────────────────────────────────
  { typeKey: "EXTRAS_PUG", title: "Extras PUG Voluntari — Lot Nord",  nrDocument: "PUG-023/2019", dateDocument: "2019-08-07",  notes: "Zonă rezidențială cu densitate mică" },
  { typeKey: "EXTRAS_PUG", title: "Extras PUG Snagov — Zonă Turism",  nrDocument: "PUG-011/2020", dateDocument: "2020-03-14",     notes: "Zonă de agrement și turism" },
  { typeKey: "EXTRAS_PUG", title: "Extras PUG Balotești — Agricol",   nrDocument: "PUG-067/2021", dateDocument: "2021-06-28",  notes: "Teren extravilan categorie arabil" },
  { typeKey: "EXTRAS_PUG", title: "Extras PUG Gruiu — Rezidențial",   nrDocument: "PUG-134/2022", dateDocument: "2022-09-12",      notes: "Zonă rezidențială aprobată HCL 45/2022" },
  { typeKey: "EXTRAS_PUG", title: "Extras PUG Cernica — Industrial",  nrDocument: "PUG-290/2023", dateDocument: "2023-04-19",    notes: "Zonă industrială și servicii" },
  // ── HOTARARE_JUDECATOREASCA ─────────────────────────────────────────────
  { typeKey: "HOTARARE_JUDECATOREASCA", title: "Hotărâre Retrocedare Teren Voluntari", nrDocument: "1123/2017", dateDocument: "2017-11-08",  notes: "Dosar 334/2017 — retrocedare teren 3.000 mp, rămasă definitivă" },
  { typeKey: "HOTARARE_JUDECATOREASCA", title: "Hotărâre Ieșire Indiviziune Snagov",   nrDocument: "445/2019",  dateDocument: "2019-06-25",    notes: "Partaj judiciar, 4 coproprietari" },
  { typeKey: "HOTARARE_JUDECATOREASCA", title: "Hotărâre Uzucapiune Cernica",          nrDocument: "2201/2020", dateDocument: "2020-09-17",  notes: "Uzucapiune tabulară, cf. art. 930 NCC" },
  { typeKey: "HOTARARE_JUDECATOREASCA", title: "Hotărâre Grănițuire Balotești",        nrDocument: "889/2021",  dateDocument: "2021-04-12",  notes: "Stabilire linie de hotar, irevocabilă" },
  { typeKey: "HOTARARE_JUDECATOREASCA", title: "Hotărâre Revendicare Imobiliară",      nrDocument: "3340/2022", dateDocument: "2022-12-06",    notes: "Admisă cererea de revendicare, apel respins" },
  // ── TESTAMENT ───────────────────────────────────────────────────────────
  { typeKey: "TESTAMENT", title: "Testament Popescu Ion",      nrDocument: "55/2016",  dateDocument: "2016-03-14",      notes: "Testament autentic, lăsat un singur moștenitor" },
  { typeKey: "TESTAMENT", title: "Testament Constantin Elena", nrDocument: "112/2018", dateDocument: "2018-09-22", notes: "Testatorul a desemnat doi legatari particulari" },
  { typeKey: "TESTAMENT", title: "Testament Radu Vasile",      nrDocument: "234/2020", dateDocument: "2020-01-10" },
  { typeKey: "TESTAMENT", title: "Testament Popa Gheorghe",    nrDocument: "501/2021", dateDocument: "2021-07-05",    notes: "Include clauză substituție vulgară" },
  { typeKey: "TESTAMENT", title: "Testament Stanescu Maria",   nrDocument: "789/2023", dateDocument: "2023-11-18" },
  // ── TITLU_PROPRIETATE ───────────────────────────────────────────────────
  { typeKey: "TITLU_PROPRIETATE", title: "Titlu Teren Arabil Voluntari",  nrDocument: "12345/2001", dateDocument: "2001-06-15",   emitent: "Comisia Județeană Ilfov", bazaLegala: "Legea 18/1991",  uatProprietate: "Voluntari",  uatProprietar: "Voluntari",  suprafata: "3.2000" },
  { typeKey: "TITLU_PROPRIETATE", title: "Titlu Pășune Snagov",           nrDocument: "23890/2003", dateDocument: "2003-09-22",     emitent: "Comisia Județeană Ilfov", bazaLegala: "Legea 169/1997", uatProprietate: "Snagov",     uatProprietar: "Snagov",     suprafata: "7.5000",  notes: "Reconstituire după defunct" },
  { typeKey: "TITLU_PROPRIETATE", title: "Titlu Teren Extravilan Gruiu",  nrDocument: "34012/2005", dateDocument: "2005-04-08",      emitent: "Comisia Județeană Ilfov", bazaLegala: "HG 834/1991",    uatProprietate: "Gruiu",      uatProprietar: "Gruiu",      suprafata: "1.8500" },
  { typeKey: "TITLU_PROPRIETATE", title: "Titlu Teren Agricol Cernica",   nrDocument: "41233/2007", dateDocument: "2007-11-30",    emitent: "Comisia Județeană Ilfov", bazaLegala: "Legea 18/1991",  uatProprietate: "Cernica",    uatProprietar: "Cernica",    suprafata: "5.0000",  notes: "Reconstituire pe numele moștenitorului" },
  { typeKey: "TITLU_PROPRIETATE", title: "Titlu Fânețe Balotești",        nrDocument: "50087/2009", dateDocument: "2009-07-14",  emitent: "Comisia Județeană Ilfov", bazaLegala: "Legea 169/1997", uatProprietate: "Balotești",  uatProprietar: "Balotești",  suprafata: "2.1200" },
  { typeKey: "TITLU_PROPRIETATE", title: "Titlu Teren Arabil Brănești",   nrDocument: "62001/2012", dateDocument: "2012-03-19",   emitent: "Comisia Județeană Ilfov", bazaLegala: "Legea 18/1991",  uatProprietate: "Brănești",   uatProprietar: "Brănești",   suprafata: "4.4000",    notes: "10 parcele comasate" },
];
...
async function seed() {
  ...
  if (documentCount.count > 0) {
    ...
    // migration_020_rename_to_document.sql, the second wordings from
    // migration_021, under the keys migration_071 gave them — per standing
    // instruction, the seed script must never auto-create new document-type
    // rows itself.
    ...
    if (missingKeys.length > 0) {
      throw new Error(
        `Cannot seed documents — lookup_document_type is missing key(s): ${missingKeys.join(", ")}. ` +
          ...
          `onwards, with the second Romanian wordings coming from migration_021, ` +
          `'Autorizare' removed again by migration_043, and the _ALT keys ` +
          `retired by migration_071_doctype_rekey.sql.`,
      );
    }
