...
function renderBaseline(lines: string[]): string {
  return (
    [
      ...
      "#      * lookup_property_person_role - CLOSED by Slice #34.04. The table is",
      "#        gone: migration_079 folded it into lookup_person_role.valid_for_property,",
      "#        so the four rows it had here and the zero the migrations seeded are",
      "#        the same question as whether that flag is ticked, which",
      "#        sync-reference-data.sql now sets by name.",
