...
> The versioned original is `ga40prj\docs\claude\shared\rules\powershell-and-windows.md`. The copy Claude
> actually **loads** is `C:\dev\.claude\rules\powershell-and-windows.md`, deployed above every repo so that
